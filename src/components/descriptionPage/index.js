...
const PageWrapper = styled(Page)`
  ...
  grid-template: 
    ...
    "personnalityTrait personnalityTrait personnalityTrait ideals ideals ideals" minmax(40px, auto)
...
export const DescriptionPage = () => <PageWrapper>
  ...
  <TextAreaField gridArea='profLanguages' label='Other Prof. & Languages' align='right'/>
